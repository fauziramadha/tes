...
<!DOCTYPE html>
               ...
               <ul class="nav__list grid">
                 ...
                 <!-- Display login/register or logout based on session -->
                  <?php if (isset($_SESSION['logged_in']) && $_SESSION['logged_in'] == true): ?>
                     ...
                     <li class="nav__item">
                        <a href="user-Orders" style="font-weight: 600; text-decoration: none; color: #fff; border-radius: 5px;">
   ...
   <script>
      ...
      function showPopup(productName, perPrice) {
         if (isLoggedIn) {
            ...
            document.getElementById('perPrice').value = perPrice; // Set per price for the product
         } else {
      ...
      document.querySelectorAll('.favorite__button').forEach(button => {
         button.addEventListener('click', function() {
            ...
            const perPrice = this.getAttribute('data-per-price'); // Assuming you have perPrice data
            showPopup(productName, perPrice);
         });
      });
