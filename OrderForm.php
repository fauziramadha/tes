...
<?php if (isset($_GET['status']) && $_GET['status'] === 'success'): ?>
   <script>alert('New order placed successfully');
   ...
   <body>
      ...
      <header class="header" id="header">
         <nav class="nav container">
            ...
            <a href="index" class="nav__logo">Oven Crust Bakery</a>
         </nav>
         ...
         <form id="specialOrderForm" action="specilOrders_process.php" method="POST" class="order__form container grid">
            <div class="order__inputs grid">
                  <div class="order__content">
                     ...
                     <input type="text" id="order-name" name="order-name" class="order__input" placeholder="Your Name" />
                     <div id="name-msg" class="validation-msg"></div>
                  </div>
                  <div class="order__content">
                     <label for="order-email" class="order__label">Email</label>
                     <input type="email" id="order-email" name="order-email" class="order__input" placeholder="Your Email"/>
                     <div id="email-msg" class="validation-msg"></div>
                  </div>
                  <div class="order__content">
                     <label for="order-phone" class="order__label">Phone Number</label>
                     <input type="tel" id="order-phone" name="order-phone" class="order__input" placeholder="Your Phone Number"/>
                     <div id="phone-msg" class="validation-msg"></div>
                  </div>
                  <div class="order__content">
                     <label for="order-date" class="order__label">Preferred Date</label>
                     <input type="date" id="order-date" name="order-date" class="order__input" />
                     <div id="date-msg" class="validation-msg"></div>
                  </div>
                  <div class="order__content">
                     <label for="order-details" class="order__label">Order Details</label>
                     <textarea id="order-details" name="order-details" class="order__input" placeholder="Your Order Details"></textarea>
